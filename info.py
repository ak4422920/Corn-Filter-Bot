...
USERNAME = environ.get('USERNAME', 'https://telegram.me/The_SonGoku')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002241963214'))
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001769437975 -1002432115506 -1002409423032').split()]
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://desi:desi@cluster0.ylhef.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002210063645'))
URL = environ.get('URL', '')

# verify system vars
IS_VERIFY = is_enabled('IS_VERIFY', True)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002271416634'))
TUTORIAL = environ.get("TUTORIAL", "https://t.me/akhowtoopenlinks/45")
TUTORIAL2 = environ.get("TUTORIAL2", "https://t.me/akhowtoopenlinks/45")
TUTORIAL3 = environ.get("TUTORIAL3", "https://t.me/akhowtoopenlinks/45")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/45a270fc6a0a1c183c614.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "4ed9f7b048d0c13394d7799f605e51a11dfacbe6")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "modijiurl.com")
SHORTENER_API2 = environ.get("SHORTENER_API2", "4ed9f7b048d0c13394d7799f605e51a11dfacbe6")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "modijiurl.com")
SHORTENER_API3 = environ.get("SHORTENER_API3", "4ed9f7b048d0c13394d7799f605e51a11dfacbe6")
